...
qubit_count = 100
tlist = np.linspace(0, 1.2e-14, 150)  # Shorter time for overnight rendering

# === Simulation Parameters ===
pulse_jitter = 0.05
amplitude_drift = 0.02
detection_noise_sigma = 0.015
apply_refresh = True  # Passive RX(pi/2) correction
...
for q in range(qubit_count):
    try:
        # Randomized parameters per qubit
...
ani.save("goldcorex_100qubit_nodecay.mp4", fps=30, dpi=100)
print("✅ Saved: goldcorex_100qubit_nodecay.mp4")
